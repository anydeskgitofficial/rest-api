...
def main(argv):
	...
	# ================
	# Everything below is handeled by in console input
	# ================
	input_result = ""
	...
	while (input_result != "4" and input_result != "4."):
		...
		if (input_result == "1" or input_result == "1."):
			...
			print(" - Don't worry, help is comming!")
			print(" - Explaining things, blah blah\n")
...
def filter_session_inbetween_dates(date_one, date_two, export_to_csv, filename=""):
	...
	if (export_to_csv == "true"):
		print(" **** Data has been successfully exported to the file \"" + str(filename[6:len(filename)]) + "\" ****\n")
